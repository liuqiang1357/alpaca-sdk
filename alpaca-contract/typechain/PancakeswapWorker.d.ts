...
interface PancakeswapWorkerInterface extends ethers.utils.Interface {
  functions: {
...
export class PancakeswapWorker extends Contract {
  ...
  interface: PancakeswapWorkerInterface;
