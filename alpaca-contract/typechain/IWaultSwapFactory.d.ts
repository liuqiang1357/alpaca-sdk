...
interface IWaultSwapFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class IWaultSwapFactory extends Contract {
  ...
  interface: IWaultSwapFactoryInterface;
