...
interface CakeMaxiWorkerInterface extends ethers.utils.Interface {
  functions: {
    ...
    "initialize(address,address,address,address,address,uint256,address,address,uint256,uint256,address[],address[])": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setBeneficialVaultBountyBps",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(functionFragment: "setPath", values: [string[]]): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "SetBeneficialVaultBountyBps(address,uint256)": EventFragment;
    "SetCriticalStrategy(address,address,address)": EventFragment;
    "SetMaxReinvestBountyBps(address,uint256)": EventFragment;
    "SetPath(address,address[])": EventFragment;
    "SetReinvestBountyBps(address,uint256)": EventFragment;
  ...
  getEvent(
    nameOrSignatureOrTopic: "SetBeneficialVaultBountyBps"
  ): EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "SetPath"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "SetReinvestBountyBps"): EventFragment;
...
export class CakeMaxiWorker extends Contract {
  ...
  interface: CakeMaxiWorkerInterface;
  ...
  functions: {
    ...
    "initialize(address,address,address,address,address,uint256,address,address,uint256,uint256,address[],address[])"(
      _operator: string,
      _baseToken: string,
      _masterChef: string,
      _router: string,
    ...
    setBeneficialVaultBountyBps(
      _beneficialVaultBountyBps: BigNumberish,
      overrides?: Overrides
    ): Promise<ContractTransaction>;

    "setBeneficialVaultBountyBps(uint256)"(
      _beneficialVaultBountyBps: BigNumberish,
      overrides?: Overrides
    ): Promise<ContractTransaction>;
  ...
  setPath(_path: string[], overrides?: Overrides): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    setPath(_path: string[], overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    SetPath(caller: string | null, newPath: null): EventFilter;

    SetReinvestBountyBps(
      caller: string | null,
      reinvestBountyBps: BigNumberish | null
    ): EventFilter;
  ...
  estimateGas: {
    ...
    setPath(_path: string[], overrides?: Overrides): Promise<BigNumber>;
