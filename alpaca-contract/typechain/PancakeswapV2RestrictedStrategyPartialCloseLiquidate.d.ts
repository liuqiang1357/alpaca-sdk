...
interface PancakeswapV2RestrictedStrategyPartialCloseLiquidateInterface
  ...
  events: {
    ...
    "PancakeswapV2RestrictedStrategyPartialCloseLiquidateEvent(address,address,uint256,uint256)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "OwnershipTransferred"): EventFragment;
  getEvent(
    nameOrSignatureOrTopic: "PancakeswapV2RestrictedStrategyPartialCloseLiquidateEvent"
  ): EventFragment;
}

export class PancakeswapV2RestrictedStrategyPartialCloseLiquidate extends Contract {
  ...
  filters: {
    ...
    PancakeswapV2RestrictedStrategyPartialCloseLiquidateEvent(
