...
interface PancakeswapV2WorkerMigrateInterface extends ethers.utils.Interface {
  functions: {
    ...
    "migrateLP(address,uint256,address,address,address,address[],address[])": FunctionFragment;
...
export class PancakeswapV2WorkerMigrate extends Contract {
  ...
  interface: PancakeswapV2WorkerMigrateInterface;
  ...
  functions: {
    ...
    migrateLP(
      ...
      _twoSideOptimalMigrateStrat: string,
      _newAddStrat: string,
      _newLiqStrat: string,
      _newOkStrats: string[],
      _disableStrats: string[],
      overrides?: Overrides
    ): Promise<ContractTransaction>;
