...
interface CakeMaxiWorker02Interface extends ethers.utils.Interface {
  functions: {
    ...
    "initialize(address,address,address,address,address,uint256,address,address,uint256,uint256,address[],address[],uint256)": FunctionFragment;
    ...
    "setReinvestConfig(uint256,uint256)": FunctionFragment;
  ...
  events: {
    ...
    "SetReinvestConfig(address,uint256,uint256)": EventFragment;
...
export class CakeMaxiWorker02 extends Contract {
  ...
  interface: CakeMaxiWorker02Interface;
  ...
  functions: {
    ...
    "initialize(address,address,address,address,address,uint256,address,address,uint256,uint256,address[],address[],uint256)"(
      _operator: string,
      _baseToken: string,
      _masterChef: string,
      _router: string,
