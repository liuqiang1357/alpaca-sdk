...
interface IWaultSwapRouter02Interface extends ethers.utils.Interface {
  functions: {
...
export class IWaultSwapRouter02 extends Contract {
  ...
  interface: IWaultSwapRouter02Interface;
