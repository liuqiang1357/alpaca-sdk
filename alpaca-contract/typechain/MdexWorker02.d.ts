...
interface MdexWorker02Interface extends ethers.utils.Interface {
  functions: {
    ...
    "getMktSellAmount(uint256,uint256,uint256,uint256)": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "bscPool", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "bscPool", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "buybackAmount",
    data: BytesLike
  ): Result;
...
export class MdexWorker02 extends Contract {
  ...
  interface: MdexWorker02Interface;
  ...
  functions: {
    ...
    bscPool(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    bscPool(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    bscPool(overrides?: CallOverrides): Promise<PopulatedTransaction>;
