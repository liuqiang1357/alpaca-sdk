...
interface IWaultSwapRouter01Interface extends ethers.utils.Interface {
  functions: {
...
export class IWaultSwapRouter01 extends Contract {
  ...
  interface: IWaultSwapRouter01Interface;
