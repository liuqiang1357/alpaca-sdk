...
interface MdexRestrictedStrategyPartialCloseMinimizeTradingInterface
  ...
  events: {
    "MdexRestrictedStrategyPartialCloseMinimizeTradingEvent(address,address,uint256,uint256)": EventFragment;
  ...
  getEvent(
    nameOrSignatureOrTopic: "MdexRestrictedStrategyPartialCloseMinimizeTradingEvent"
  ): EventFragment;
...
export class MdexRestrictedStrategyPartialCloseMinimizeTrading extends Contract {
  ...
  filters: {
    MdexRestrictedStrategyPartialCloseMinimizeTradingEvent(
