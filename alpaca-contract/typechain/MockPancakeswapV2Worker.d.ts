...
interface MockPancakeswapV2WorkerInterface extends ethers.utils.Interface {
  functions: {
...
export class MockPancakeswapV2Worker extends Contract {
  ...
  interface: MockPancakeswapV2WorkerInterface;
