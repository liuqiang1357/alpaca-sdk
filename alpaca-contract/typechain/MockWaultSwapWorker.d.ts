...
interface MockWaultSwapWorkerInterface extends ethers.utils.Interface {
  functions: {
...
export class MockWaultSwapWorker extends Contract {
  ...
  interface: MockWaultSwapWorkerInterface;
