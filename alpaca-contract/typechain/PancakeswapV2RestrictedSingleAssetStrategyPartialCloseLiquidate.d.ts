...
interface PancakeswapV2RestrictedSingleAssetStrategyPartialCloseLiquidateInterface
  ...
  events: {
    ...
    "PancakeswapV2RestrictedSingleAssetStrategyPartialCloseLiquidateEvent(address,address,uint256,uint256)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "OwnershipTransferred"): EventFragment;
  getEvent(
    nameOrSignatureOrTopic: "PancakeswapV2RestrictedSingleAssetStrategyPartialCloseLiquidateEvent"
  ): EventFragment;
}

export class PancakeswapV2RestrictedSingleAssetStrategyPartialCloseLiquidate extends Contract {
  ...
  filters: {
    ...
    PancakeswapV2RestrictedSingleAssetStrategyPartialCloseLiquidateEvent(
