...
interface IMigratorFairLaunchInterface extends ethers.utils.Interface {
  functions: {
...
export class IMigratorFairLaunch extends Contract {
  ...
  interface: IMigratorFairLaunchInterface;
