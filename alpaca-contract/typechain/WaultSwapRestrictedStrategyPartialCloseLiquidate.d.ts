...
interface WaultSwapRestrictedStrategyPartialCloseLiquidateInterface
  ...
  events: {
    ...
    "WaultSwapRestrictedStrategyPartialCloseLiquidateEvent(address,address,uint256,uint256)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "OwnershipTransferred"): EventFragment;
  getEvent(
    nameOrSignatureOrTopic: "WaultSwapRestrictedStrategyPartialCloseLiquidateEvent"
  ): EventFragment;
}

export class WaultSwapRestrictedStrategyPartialCloseLiquidate extends Contract {
  ...
  filters: {
    ...
    WaultSwapRestrictedStrategyPartialCloseLiquidateEvent(
