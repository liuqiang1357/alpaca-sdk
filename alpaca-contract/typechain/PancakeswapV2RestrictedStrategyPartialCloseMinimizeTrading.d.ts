...
interface PancakeswapV2RestrictedStrategyPartialCloseMinimizeTradingInterface
  ...
  events: {
    ...
    "PancakeswapV2RestrictedStrategyPartialCloseMinimizeTradingEvent(address,address,uint256,uint256)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "OwnershipTransferred"): EventFragment;
  getEvent(
    nameOrSignatureOrTopic: "PancakeswapV2RestrictedStrategyPartialCloseMinimizeTradingEvent"
  ): EventFragment;
}

export class PancakeswapV2RestrictedStrategyPartialCloseMinimizeTrading extends Contract {
  ...
  filters: {
    ...
    PancakeswapV2RestrictedStrategyPartialCloseMinimizeTradingEvent(
