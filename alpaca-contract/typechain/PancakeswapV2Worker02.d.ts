...
interface PancakeswapV2Worker02Interface extends ethers.utils.Interface {
  functions: {
...
export class PancakeswapV2Worker02 extends Contract {
  ...
  interface: PancakeswapV2Worker02Interface;
