...
var IPancakePair = _interopDefault(require('@alpaca-finance/pancake-swap-core/build/IPancakePair.json'));
...
var _10000 = /*#__PURE__*/JSBI.BigInt(10000); // PancakeSwapV2
...
var Pair = /*#__PURE__*/function () {
  ...
  _proto.getOutputAmount = function getOutputAmount(inputAmount, tradingFeeBasisPoint) {
    ...
    var inputAmountWithFee = JSBI.multiply(inputAmount.raw, JSBI.BigInt(tradingFeeBasisPoint));
  ...
  _proto.getInputAmount = function getInputAmount(outputAmount, tradingFeeBasisPoint) {
    ...
    var denominator = JSBI.multiply(JSBI.subtract(outputReserve.raw, outputAmount.raw), JSBI.BigInt(tradingFeeBasisPoint));
...
var Trade = /*#__PURE__*/function () {
  function Trade(route, amount, tradeType, tradingFeeBasisPoint) {
    ...
    if (tradeType === exports.TradeType.EXACT_INPUT) {
      ...
      for (var i = 0; i < route.path.length - 1; i++) {
        ...
        var _pair$getOutputAmount = pair.getOutputAmount(amounts[i], tradingFeeBasisPoint),
      ...
      for (var _i = route.path.length - 1; _i > 0; _i--) {
        ...
        var _pair$getInputAmount = _pair.getInputAmount(amounts[_i], tradingFeeBasisPoint),
    ...
    this.tradingFeeBasisPoint = tradingFeeBasisPoint;
  }
  /**
  ...
  Trade.exactIn = function exactIn(route, amountIn, tradingFeeBasisPoint) {
    return new Trade(route, amountIn, exports.TradeType.EXACT_INPUT, tradingFeeBasisPoint);
  }
  /**
  ...
  Trade.exactOut = function exactOut(route, amountOut, tradingFeeBasisPoint) {
    return new Trade(route, amountOut, exports.TradeType.EXACT_OUTPUT, tradingFeeBasisPoint);
  }
  /**
  ...
  Trade.bestTradeExactIn = function bestTradeExactIn(pairs, currencyAmountIn, currencyOut, _temp, tradingFeeBasisPoint, // used in recursion.
  currentPairs, originalAmountIn, bestTrades) {
    ...
    for (var i = 0; i < pairs.length; i++) {
      ...
      try {
        ...
        var _pair$getOutputAmount2 = pair.getOutputAmount(amountIn, tradingFeeBasisPoint);
      ...
      if (amountOut.token.equals(tokenOut)) {
        sortedInsert(bestTrades, new Trade(new Route([].concat(currentPairs, [pair]), originalAmountIn.currency, currencyOut), originalAmountIn, exports.TradeType.EXACT_INPUT, tradingFeeBasisPoint), maxNumResults, tradeComparator);
        ...
        Trade.bestTradeExactIn(pairsExcludingThisPair, amountOut, currencyOut, {
          ...
          maxHops: maxHops - 1
        }, tradingFeeBasisPoint, [].concat(currentPairs, [pair]), originalAmountIn, bestTrades);
      }
    }
  ...
  Trade.bestTradeExactOut = function bestTradeExactOut(pairs, currencyIn, currencyAmountOut, _temp2, tradingFeeBasisPoint, // used in recursion.
  currentPairs, originalAmountOut, bestTrades) {
    ...
    for (var i = 0; i < pairs.length; i++) {
      ...
      try {
        ...
        var _pair$getInputAmount2 = pair.getInputAmount(amountOut, tradingFeeBasisPoint);
      ...
      if (amountIn.token.equals(tokenIn)) {
        sortedInsert(bestTrades, new Trade(new Route([pair].concat(currentPairs), currencyIn, originalAmountOut.currency), originalAmountOut, exports.TradeType.EXACT_OUTPUT, tradingFeeBasisPoint), maxNumResults, tradeComparator);
      } else if (maxHops > 1 && pairs.length > 1) {
        ...
        Trade.bestTradeExactOut(pairsExcludingThisPair, currencyIn, amountIn, {
          maxNumResults: maxNumResults,
          maxHops: maxHops - 1
        }, tradingFeeBasisPoint, [pair].concat(currentPairs), originalAmountOut, bestTrades);
      }
    }
...
//# sourceMappingURL=pancakeswap-sdk.cjs.development.js.map
