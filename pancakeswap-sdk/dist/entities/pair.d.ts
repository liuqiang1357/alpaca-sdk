...
export declare class Pair {
    ...
    getOutputAmount(inputAmount: TokenAmount, tradingFeeBasisPoint: BigintIsh): [TokenAmount, Pair];
    getInputAmount(outputAmount: TokenAmount, tradingFeeBasisPoint: BigintIsh): [TokenAmount, Pair];
