...
export interface IBookKeeperFlashBorrowerInterface extends ethers.utils.Interface {
    functions: {
...
export interface IBookKeeperFlashBorrower extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: IBookKeeperFlashBorrowerInterface;
