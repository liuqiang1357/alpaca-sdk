...
import type {
  IAlpacaVaultConfig,
  IAlpacaVaultConfigInterface,
} from "../IAlpacaVaultConfig";
...
export class IAlpacaVaultConfig__factory {
  static readonly abi = _abi;
  static createInterface(): IAlpacaVaultConfigInterface {
    return new utils.Interface(_abi) as IAlpacaVaultConfigInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IAlpacaVaultConfig {
    return new Contract(address, _abi, signerOrProvider) as IAlpacaVaultConfig;
  }
}
