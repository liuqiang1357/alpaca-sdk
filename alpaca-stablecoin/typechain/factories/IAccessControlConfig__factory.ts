...
import type {
  ...
  IAccessControlConfigInterface,
} from "../IAccessControlConfig";
...
export class IAccessControlConfig__factory {
  static readonly abi = _abi;
  static createInterface(): IAccessControlConfigInterface {
    return new utils.Interface(_abi) as IAccessControlConfigInterface;
  }
  static connect(
    address: string,
