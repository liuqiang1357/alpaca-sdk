...
export interface IbTokenAdapterInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "accRewardBalance",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "netAssetPerShare",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "netAssetValuation",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "netPendingRewards",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setTreasuryAccount",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "setTreasuryFeeBps",
    values: [BigNumberish]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "treasuryFeeBps",
    values?: undefined
  ): string;
...
export type LogDepositEvent = TypedEvent<[BigNumber], { _val: BigNumber }>;

export type LogDepositEventFilter = TypedEventFilter<LogDepositEvent>;

export type LogEmergencyWithdrawEvent = TypedEvent<
  [string, string],
  { _caller: string; _to: string }
>;

export type LogEmergencyWithdrawEventFilter =
  TypedEventFilter<LogEmergencyWithdrawEvent>;

export type LogMoveStakeEvent = TypedEvent<
  [string, string, BigNumber],
  { _src: string; _dst: string; _wad: BigNumber }
>;

export type LogMoveStakeEventFilter = TypedEventFilter<LogMoveStakeEvent>;

export type LogSetTreasuryAccountEvent = TypedEvent<
  [string, string],
  { _caller: string; _treasuryAccount: string }
>;

export type LogSetTreasuryAccountEventFilter =
  TypedEventFilter<LogSetTreasuryAccountEvent>;

export type LogSetTreasuryFeeBpsEvent = TypedEvent<
  [string, BigNumber],
  { _caller: string; _treasuryFeeBps: BigNumber }
>;

export type LogSetTreasuryFeeBpsEventFilter =
  TypedEventFilter<LogSetTreasuryFeeBpsEvent>;

export type LogUncageEvent = TypedEvent<[], {}>;

export type LogUncageEventFilter = TypedEventFilter<LogUncageEvent>;

export type LogWithdrawEvent = TypedEvent<[BigNumber], { _val: BigNumber }>;
...
export interface IbTokenAdapter extends BaseContract {
  ...
  filters: {
    ...
    "LogEmergencyWithdraw(address,address)"(
      _caller?: string | null,
      _to?: null
    ...
    "LogMoveStake(address,address,uint256)"(
      _src?: string | null,
      _dst?: string | null,
      _wad?: null
    ): LogMoveStakeEventFilter;
    LogMoveStake(
      _src?: string | null,
      _dst?: string | null,
      _wad?: null
    ...
    "LogSetTreasuryAccount(address,address)"(
      _caller?: string | null,
      _treasuryAccount?: null
    ): LogSetTreasuryAccountEventFilter;
    LogSetTreasuryAccount(
      _caller?: string | null,
      _treasuryAccount?: null
    ): LogSetTreasuryAccountEventFilter;

    "LogSetTreasuryFeeBps(address,uint256)"(
      _caller?: string | null,
      _treasuryFeeBps?: null
    ): LogSetTreasuryFeeBpsEventFilter;
    LogSetTreasuryFeeBps(
      _caller?: string | null,
      _treasuryFeeBps?: null
    ): LogSetTreasuryFeeBpsEventFilter;
