...
export interface FixedSpreadLiquidationStrategyInterface
  ...
  encodeFunctionData(
    functionFragment: "flashLendingEnabled",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setFlashLendingEnabled",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export type LogFixedSpreadLiquidateEvent = TypedEvent<
  [
    string,
    BigNumber,
    BigNumber,
...
export type LogFixedSpreadLiquidateEventFilter =
  TypedEventFilter<LogFixedSpreadLiquidateEvent>;

export type LogSetFlashLendingEnabledEvent = TypedEvent<
  [string, BigNumber],
  { caller: string; _flashLendingEnabled: BigNumber }
>;

export type LogSetFlashLendingEnabledEventFilter =
  TypedEventFilter<LogSetFlashLendingEnabledEvent>;
...
export interface FixedSpreadLiquidationStrategy extends BaseContract {
  ...
  functions: {
    ...
    execute(
      ...
      _positionDebtShare: BigNumberish,
      _positionCollateralAmount: BigNumberish,
      _positionAddress: string,
    ...
    setFlashLendingEnabled(
      _flashLendingEnabled: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    "LogFixedSpreadLiquidate(bytes32,uint256,uint256,address,uint256,uint256,address,address,uint256,uint256,uint256,uint256)"(
      _collateralPoolId?: BytesLike | null,
      _positionDebtShare?: null,
      _positionCollateralAmount?: null,
      _positionAddress?: string | null,
      _debtShareToBeLiquidated?: null,
      _maxDebtShareToBeLiquidated?: null,
      _liquidatorAddress?: string | null,
      _collateralRecipient?: null,
      _actualDebtShareToBeLiquidated?: null,
      _actualDebtValueToBeLiquidated?: null,
      _collateralAmountToBeLiquidated?: null,
      _treasuryFees?: null
    ): LogFixedSpreadLiquidateEventFilter;
    LogFixedSpreadLiquidate(
      _collateralPoolId?: BytesLike | null,
      _positionDebtShare?: null,
      _positionCollateralAmount?: null,
      _positionAddress?: string | null,
    ...
    "LogSetFlashLendingEnabled(address,uint256)"(
      caller?: string | null,
      _flashLendingEnabled?: null
    ): LogSetFlashLendingEnabledEventFilter;
    LogSetFlashLendingEnabled(
      caller?: string | null,
      _flashLendingEnabled?: null
    ): LogSetFlashLendingEnabledEventFilter;
