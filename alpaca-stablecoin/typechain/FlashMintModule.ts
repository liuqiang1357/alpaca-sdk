...
export type LogBookKeeperFlashLoanEvent = TypedEvent<
  [string, BigNumber, BigNumber],
  { _receiver: string; _amount: BigNumber; _fee: BigNumber }
>;

export type LogBookKeeperFlashLoanEventFilter =
  TypedEventFilter<LogBookKeeperFlashLoanEvent>;

export type LogFlashLoanEvent = TypedEvent<
  [string, string, BigNumber, BigNumber],
  { _receiver: string; _token: string; _amount: BigNumber; _fee: BigNumber }
>;

export type LogFlashLoanEventFilter = TypedEventFilter<LogFlashLoanEvent>;

export type LogSetFeeRateEvent = TypedEvent<[BigNumber], { _data: BigNumber }>;

export type LogSetFeeRateEventFilter = TypedEventFilter<LogSetFeeRateEvent>;

export type LogSetMaxEvent = TypedEvent<[BigNumber], { _data: BigNumber }>;

export type LogSetMaxEventFilter = TypedEventFilter<LogSetMaxEvent>;
...
export interface FlashMintModule extends BaseContract {
  ...
  filters: {
    "LogBookKeeperFlashLoan(address,uint256,uint256)"(
      _receiver?: string | null,
      _amount?: null,
      _fee?: null
    ): LogBookKeeperFlashLoanEventFilter;
    ...
    "LogFlashLoan(address,address,uint256,uint256)"(
      _receiver?: string | null,
      _token?: null,
      _amount?: null,
      _fee?: null
