...
export interface StabilityFeeCollectorInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "globalStabilityFeeRate",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setGlobalStabilityFeeRate",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  getEvent(
    nameOrSignatureOrTopic: "LogSetGlobalStabilityFeeRate"
  ): EventFragment;
...
export type LogSetGlobalStabilityFeeRateEvent = TypedEvent<
  [string, BigNumber],
  { _caller: string; _data: BigNumber }
>;

export type LogSetGlobalStabilityFeeRateEventFilter =
  TypedEventFilter<LogSetGlobalStabilityFeeRateEvent>;

export type LogSetSystemDebtEngineEvent = TypedEvent<
  [string, string],
  { _caller: string; _data: string }
>;
...
export interface StabilityFeeCollector extends BaseContract {
  ...
  functions: {
    ...
    setGlobalStabilityFeeRate(
      _globalStabilityFeeRate: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    "LogSetGlobalStabilityFeeRate(address,uint256)"(
      _caller?: string | null,
      _data?: null
    ): LogSetGlobalStabilityFeeRateEventFilter;
    LogSetGlobalStabilityFeeRate(
      _caller?: string | null,
      _data?: null
    ): LogSetGlobalStabilityFeeRateEventFilter;
