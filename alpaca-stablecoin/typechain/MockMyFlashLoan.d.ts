...
export interface MockMyFlashLoanInterface extends ethers.utils.Interface {
    functions: {
...
export interface MockMyFlashLoan extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: MockMyFlashLoanInterface;
