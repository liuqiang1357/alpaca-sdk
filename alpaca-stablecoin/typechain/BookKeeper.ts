...
export interface BookKeeperInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "setAccessControlConfig",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "setCollateralPoolConfig",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "setTotalDebtCeiling",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "totalUnbackedStablecoin",
    values?: undefined
  ): string;
...
export type LogAddCollateralEvent = TypedEvent<
  ...
  { _caller: string; _usr: string; _amount: BigNumber }
>;

export type LogAddCollateralEventFilter =
  TypedEventFilter<LogAddCollateralEvent>;

export type LogAdjustPositionEvent = TypedEvent<
...
export type LogAdjustPositionEventFilter =
  TypedEventFilter<LogAdjustPositionEvent>;

export type LogCageEvent = TypedEvent<[], {}>;

export type LogCageEventFilter = TypedEventFilter<LogCageEvent>;

export type LogMoveCollateralEvent = TypedEvent<
...
export type LogMoveCollateralEventFilter =
  TypedEventFilter<LogMoveCollateralEvent>;

export type LogSetAccessControlConfigEvent = TypedEvent<
  [string, string],
  { _caller: string; _accessControlConfig: string }
>;

export type LogSetAccessControlConfigEventFilter =
  TypedEventFilter<LogSetAccessControlConfigEvent>;

export type LogSetCollateralPoolConfigEvent = TypedEvent<
  [string, string],
  { _caller: string; _collateralPoolConfig: string }
>;

export type LogSetCollateralPoolConfigEventFilter =
  TypedEventFilter<LogSetCollateralPoolConfigEvent>;

export type LogSetTotalDebtCeilingEvent = TypedEvent<
  [string, BigNumber],
  { _caller: string; _totalDebtCeiling: BigNumber }
>;

export type LogSetTotalDebtCeilingEventFilter =
  TypedEventFilter<LogSetTotalDebtCeilingEvent>;
...
export interface BookKeeper extends BaseContract {
  ...
  functions: {
    ...
    adjustPosition(
      _collateralPoolId: BytesLike,
      _positionAddress: string,
      _collateralOwner: string,
      _stablecoinOwner: string,
    ...
    confiscatePosition(
      _collateralPoolId: BytesLike,
      _positionAddress: string,
      _collateralCreditor: string,
      _stablecoinDebtor: string,
    ...
    setTotalDebtCeiling(
      _totalDebtCeiling: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    "LogAddCollateral(address,address,int256)"(
      _caller?: string | null,
      _usr?: null,
      _amount?: null
    ...
    "LogAdjustPosition(address,bytes32,address,uint256,uint256,int256,int256)"(
      _caller?: string | null,
    ...
    "LogMoveCollateral(address,bytes32,address,address,uint256)"(
      _caller?: string | null,
      _collateralPoolId?: null,
      _src?: null,
      _dst?: null,
      _amount?: null
    ): LogMoveCollateralEventFilter;
    LogMoveCollateral(
      _caller?: string | null,
      _collateralPoolId?: null,
      _src?: null,
    ...
    "LogSetAccessControlConfig(address,address)"(
      _caller?: string | null,
      _accessControlConfig?: null
    ): LogSetAccessControlConfigEventFilter;
    LogSetAccessControlConfig(
      _caller?: string | null,
      _accessControlConfig?: null
    ): LogSetAccessControlConfigEventFilter;

    "LogSetCollateralPoolConfig(address,address)"(
      _caller?: string | null,
      _collateralPoolConfig?: null
    ): LogSetCollateralPoolConfigEventFilter;
    LogSetCollateralPoolConfig(
      _caller?: string | null,
      _collateralPoolConfig?: null
    ): LogSetCollateralPoolConfigEventFilter;

    "LogSetTotalDebtCeiling(address,uint256)"(
      _caller?: string | null,
      _totalDebtCeiling?: null
    ): LogSetTotalDebtCeilingEventFilter;
