...
export interface StaticPriceFeedInterface extends ethers.utils.Interface {
    functions: {
...
export interface StaticPriceFeed extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: StaticPriceFeedInterface;
