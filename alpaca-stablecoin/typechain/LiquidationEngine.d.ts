...
export interface LiquidationEngineInterface extends ethers.utils.Interface {
    ...
    encodeFunctionData(functionFragment: "liquidate", values: [BytesLike, string, BigNumberish, BigNumberish, string, BytesLike]): string;
...
export interface LiquidationEngine extends BaseContract {
    ...
    functions: {
        ...
        liquidate(_collateralPoolId: BytesLike, _positionAddress: string, _debtShareToBeLiquidated: BigNumberish, _maxDebtShareToBeLiquidated: BigNumberish, _collateralRecipient: string, _data: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        liquidate(_collateralPoolId: BytesLike, _positionAddress: string, _debtShareToBeLiquidated: BigNumberish, _maxDebtShareToBeLiquidated: BigNumberish, _collateralRecipient: string, _data: BytesLike, overrides?: CallOverrides): Promise<void>;
        live(overrides?: CallOverrides): Promise<BigNumber>;
