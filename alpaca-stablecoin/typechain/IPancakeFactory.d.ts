...
export interface IPancakeFactoryInterface extends ethers.utils.Interface {
    functions: {
...
export interface IPancakeFactory extends BaseContract {
    ...
    filters: {
        "PairCreated(address,address,address,uint256)"(token0?: string | null, token1?: string | null, pair?: null, undefined?: null): PairCreatedEventFilter;
        PairCreated(token0?: string | null, token1?: string | null, pair?: null, undefined?: null): PairCreatedEventFilter;
    };
    estimateGas: {
