...
export interface ShowStopperInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "accumulateBadDebt",
    values: [BytesLike, string]
  ): string;
  encodeFunctionData(
    functionFragment: "accumulateStablecoin",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "badDebtAccumulator",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "cageCoolDown",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "cagePrice",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
    functionFragment: "cagedTimestamp",
    values?: undefined
  ): string;
  encodeFunctionData(functionFragment: "debt", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "finalCashPrice",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
    functionFragment: "finalizeCashPrice",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
    functionFragment: "finalizeDebt",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "redeemedStablecoinAmount",
    values: [BytesLike, string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setCageCoolDown",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "setLiquidationEngine",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setSystemDebtEngine",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "stablecoinAccumulator",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "totalDebtShare",
    values: [BytesLike]
  ): string;
...
export type LogAccumulateBadDebtEvent = TypedEvent<
...
export type LogAccumulateBadDebtEventFilter =
  TypedEventFilter<LogAccumulateBadDebtEvent>;

export type LogAccumulateStablecoinEvent = TypedEvent<
  [string, BigNumber],
  { ownerAddress: string; amount: BigNumber }
>;

export type LogAccumulateStablecoinEventFilter =
  TypedEventFilter<LogAccumulateStablecoinEvent>;

export type LogCageEvent = TypedEvent<[], {}>;

export type LogCageEventFilter = TypedEventFilter<LogCageEvent>;

export type LogCageCollateralPoolEvent = TypedEvent<
  [string],
  { collateralPoolId: string }
>;

export type LogCageCollateralPoolEventFilter =
  TypedEventFilter<LogCageCollateralPoolEvent>;

export type LogFinalizeCashPriceEvent = TypedEvent<
  [string],
  { collateralPoolId: string }
>;

export type LogFinalizeCashPriceEventFilter =
  TypedEventFilter<LogFinalizeCashPriceEvent>;

export type LogFinalizeDebtEvent = TypedEvent<[], {}>;

export type LogFinalizeDebtEventFilter = TypedEventFilter<LogFinalizeDebtEvent>;

export type LogRedeemLockedCollateralEvent = TypedEvent<
...
export type LogRedeemLockedCollateralEventFilter =
  TypedEventFilter<LogRedeemLockedCollateralEvent>;

export type LogRedeemStablecoinEvent = TypedEvent<
  [string, string, BigNumber],
  { collateralPoolId: string; ownerAddress: string; amount: BigNumber }
>;

export type LogRedeemStablecoinEventFilter =
  TypedEventFilter<LogRedeemStablecoinEvent>;

export type LogSetBookKeeperEvent = TypedEvent<
  [string, string],
  { caller: string; _bookKeeper: string }
>;

export type LogSetBookKeeperEventFilter =
  TypedEventFilter<LogSetBookKeeperEvent>;

export type LogSetCageCoolDownEvent = TypedEvent<
  [string, BigNumber],
  { caller: string; _cageCoolDown: BigNumber }
>;

export type LogSetCageCoolDownEventFilter =
  TypedEventFilter<LogSetCageCoolDownEvent>;

export type LogSetLiquidationEngineEvent = TypedEvent<
  [string, string],
  { caller: string; _liquidationEngine: string }
>;

export type LogSetLiquidationEngineEventFilter =
  TypedEventFilter<LogSetLiquidationEngineEvent>;

export type LogSetPriceOracleEvent = TypedEvent<
  [string, string],
  { caller: string; _priceOracle: string }
>;

export type LogSetPriceOracleEventFilter =
  TypedEventFilter<LogSetPriceOracleEvent>;

export type LogSetSystemDebtEngineEvent = TypedEvent<
  [string, string],
  { caller: string; _systemDebtEngine: string }
>;

export type LogSetSystemDebtEngineEventFilter =
  TypedEventFilter<LogSetSystemDebtEngineEvent>;
...
export interface ShowStopper extends BaseContract {
  ...
  filters: {
    "LogAccumulateBadDebt(bytes32,address,uint256,uint256)"(
      collateralPoolId?: BytesLike | null,
      positionAddress?: string | null,
      amount?: null,
      debtShare?: null
    ): LogAccumulateBadDebtEventFilter;
    LogAccumulateBadDebt(
      collateralPoolId?: BytesLike | null,
      positionAddress?: string | null,
      amount?: null,
      debtShare?: null
    ...
    "LogAccumulateStablecoin(address,uint256)"(
      ownerAddress?: string | null,
      amount?: null
    ): LogAccumulateStablecoinEventFilter;
    LogAccumulateStablecoin(
      ownerAddress?: string | null,
      amount?: null
    ): LogAccumulateStablecoinEventFilter;
    ...
    "LogCageCollateralPool(bytes32)"(
      collateralPoolId?: BytesLike | null
    ): LogCageCollateralPoolEventFilter;
    LogCageCollateralPool(
      collateralPoolId?: BytesLike | null
    ): LogCageCollateralPoolEventFilter;

    "LogFinalizeCashPrice(bytes32)"(
      collateralPoolId?: BytesLike | null
    ): LogFinalizeCashPriceEventFilter;
    LogFinalizeCashPrice(
      collateralPoolId?: BytesLike | null
    ): LogFinalizeCashPriceEventFilter;
    ...
    "LogRedeemLockedCollateral(bytes32,address,uint256)"(
      collateralPoolId?: BytesLike | null,
      positionAddress?: string | null,
      lockedCollateral?: null
    ): LogRedeemLockedCollateralEventFilter;
    LogRedeemLockedCollateral(
      collateralPoolId?: BytesLike | null,
      positionAddress?: string | null,
      lockedCollateral?: null
    ): LogRedeemLockedCollateralEventFilter;

    "LogRedeemStablecoin(bytes32,address,uint256)"(
      collateralPoolId?: BytesLike | null,
      ownerAddress?: string | null,
      amount?: null
    ): LogRedeemStablecoinEventFilter;
    LogRedeemStablecoin(
      collateralPoolId?: BytesLike | null,
      ownerAddress?: string | null,
      amount?: null
    ...
    "LogSetBookKeeper(address,address)"(
      caller?: string | null,
      _bookKeeper?: null
    ): LogSetBookKeeperEventFilter;
    LogSetBookKeeper(
      caller?: string | null,
      _bookKeeper?: null
    ): LogSetBookKeeperEventFilter;

    "LogSetCageCoolDown(address,uint256)"(
      caller?: string | null,
      _cageCoolDown?: null
    ): LogSetCageCoolDownEventFilter;
    LogSetCageCoolDown(
      caller?: string | null,
      _cageCoolDown?: null
    ): LogSetCageCoolDownEventFilter;

    "LogSetLiquidationEngine(address,address)"(
      caller?: string | null,
      _liquidationEngine?: null
    ): LogSetLiquidationEngineEventFilter;
    LogSetLiquidationEngine(
      caller?: string | null,
      _liquidationEngine?: null
    ): LogSetLiquidationEngineEventFilter;

    "LogSetPriceOracle(address,address)"(
      caller?: string | null,
      _priceOracle?: null
    ): LogSetPriceOracleEventFilter;
    LogSetPriceOracle(
      caller?: string | null,
      _priceOracle?: null
    ): LogSetPriceOracleEventFilter;

    "LogSetSystemDebtEngine(address,address)"(
      caller?: string | null,
      _systemDebtEngine?: null
    ): LogSetSystemDebtEngineEventFilter;
    LogSetSystemDebtEngine(
      caller?: string | null,
      _systemDebtEngine?: null
    ): LogSetSystemDebtEngineEventFilter;
