...
export interface StrictAlpacaOraclePriceFeedInterface
  ...
  encodeFunctionData(
    functionFragment: "setMaxPriceDiff",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export type LogSetMaxPriceDiffEvent = TypedEvent<
  [string, BigNumber],
  { caller: string; maxPriceDiff: BigNumber }
>;

export type LogSetMaxPriceDiffEventFilter =
  TypedEventFilter<LogSetMaxPriceDiffEvent>;

export type LogSetPriceLifeEvent = TypedEvent<
  [string, BigNumber],
  { caller: string; second: BigNumber }
>;

export type LogSetPriceLifeEventFilter = TypedEventFilter<LogSetPriceLifeEvent>;

export type LogSetPrimaryEvent = TypedEvent<
...
export type LogSetPrimaryEventFilter = TypedEventFilter<LogSetPrimaryEvent>;

export type LogSetSecondaryEvent = TypedEvent<
  [string, string, string, string],
  {
    caller: string;
    newAlpacaOracle: string;
...
export type LogSetSecondaryEventFilter = TypedEventFilter<LogSetSecondaryEvent>;
...
export interface StrictAlpacaOraclePriceFeed extends BaseContract {
  ...
  functions: {
    ...
    initialize(
      _primaryAlpacaOracle: string,
      _primaryToken0: string,
      _primaryToken1: string,
      _secondaryAlpacaOracle: string,
      _secondaryToken0: string,
      _secondaryToken1: string,
  ...
  filters: {
    "LogSetMaxPriceDiff(address,uint256)"(
      caller?: string | null,
      maxPriceDiff?: null
    ): LogSetMaxPriceDiffEventFilter;
    LogSetMaxPriceDiff(
      caller?: string | null,
      maxPriceDiff?: null
    ): LogSetMaxPriceDiffEventFilter;
    ...
    "LogSetPrimary(address,address,address,address)"(
      caller?: string | null,
      newAlpacaOracle?: null,
      primaryToken0?: null,
      primaryToken1?: null
    ): LogSetPrimaryEventFilter;
    LogSetPrimary(
      caller?: string | null,
      newAlpacaOracle?: null,
      primaryToken0?: null,
    ...
    "LogSetSecondary(address,address,address,address)"(
      caller?: string | null,
      newAlpacaOracle?: null,
      secondaryToken0?: null,
      secondaryToken1?: null
    ): LogSetSecondaryEventFilter;
    LogSetSecondary(
      caller?: string | null,
      newAlpacaOracle?: null,
      secondaryToken0?: null,
