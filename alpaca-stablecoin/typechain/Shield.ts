...
export type AddPoolEvent = TypedEvent<
  ...
  { _pid: BigNumber; _allocPoint: BigNumber; _stakeToken: string }
>;

export type AddPoolEventFilter = TypedEventFilter<AddPoolEvent>;

export type MintWarchestEvent = TypedEvent<
  [string, BigNumber],
  { _to: string; _amount: BigNumber }
>;

export type MintWarchestEventFilter = TypedEventFilter<MintWarchestEvent>;
...
export type SetAlpacaPerBlockEvent = TypedEvent<
  [BigNumber],
  { _alpacaPerBlock: BigNumber }
>;

export type SetAlpacaPerBlockEventFilter =
  TypedEventFilter<SetAlpacaPerBlockEvent>;

export type SetBonusEvent = TypedEvent<
...
export type SetBonusEventFilter = TypedEventFilter<SetBonusEvent>;

export type SetPoolEvent = TypedEvent<
  [BigNumber, BigNumber],
  { _pid: BigNumber; _allocPoint: BigNumber }
>;
...
export interface Shield extends BaseContract {
  ...
  filters: {
    ...
    "SetAlpacaPerBlock(uint256)"(
      _alpacaPerBlock?: BigNumberish | null
    ): SetAlpacaPerBlockEventFilter;
    SetAlpacaPerBlock(
      _alpacaPerBlock?: BigNumberish | null
    ): SetAlpacaPerBlockEventFilter;
