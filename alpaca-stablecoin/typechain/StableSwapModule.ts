...
export interface StableSwapModuleInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "authTokenAdapter",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "setFeeIn",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "setFeeOut",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "stablecoinAdapter",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "swapStablecoinToToken",
    values: [string, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "swapTokenToStablecoin",
    values: [string, BigNumberish]
  ): string;
  encodeFunctionData(
...
export type LogSetFeeInEvent = TypedEvent<
  [string, BigNumber],
  { _caller: string; _feeIn: BigNumber }
>;

export type LogSetFeeInEventFilter = TypedEventFilter<LogSetFeeInEvent>;

export type LogSetFeeOutEvent = TypedEvent<
  [string, BigNumber],
  { _caller: string; _feeOut: BigNumber }
>;

export type LogSetFeeOutEventFilter = TypedEventFilter<LogSetFeeOutEvent>;

export type LogSwapStablecoinToTokenEvent = TypedEvent<
  [string, BigNumber, BigNumber],
  { _owner: string; _value: BigNumber; _fee: BigNumber }
>;

export type LogSwapStablecoinToTokenEventFilter =
  TypedEventFilter<LogSwapStablecoinToTokenEvent>;

export type LogSwapTokenToStablecoinEvent = TypedEvent<
  [string, BigNumber, BigNumber],
  { _owner: string; _value: BigNumber; _fee: BigNumber }
>;

export type LogSwapTokenToStablecoinEventFilter =
  TypedEventFilter<LogSwapTokenToStablecoinEvent>;
...
export interface StableSwapModule extends BaseContract {
  ...
  filters: {
    "LogSetFeeIn(address,uint256)"(
      _caller?: string | null,
      _feeIn?: null
    ): LogSetFeeInEventFilter;
    LogSetFeeIn(_caller?: string | null, _feeIn?: null): LogSetFeeInEventFilter;

    "LogSetFeeOut(address,uint256)"(
      _caller?: string | null,
      _feeOut?: null
    ): LogSetFeeOutEventFilter;
    LogSetFeeOut(
      _caller?: string | null,
      _feeOut?: null
    ): LogSetFeeOutEventFilter;

    "LogSwapStablecoinToToken(address,uint256,uint256)"(
      _owner?: string | null,
      _value?: null,
      _fee?: null
    ): LogSwapStablecoinToTokenEventFilter;
    LogSwapStablecoinToToken(
      _owner?: string | null,
      _value?: null,
      _fee?: null
    ): LogSwapStablecoinToTokenEventFilter;

    "LogSwapTokenToStablecoin(address,uint256,uint256)"(
      _owner?: string | null,
      _value?: null,
      _fee?: null
    ): LogSwapTokenToStablecoinEventFilter;
    LogSwapTokenToStablecoin(
      _owner?: string | null,
      _value?: null,
      _fee?: null
    ): LogSwapTokenToStablecoinEventFilter;
