...
export interface IFlashLendingCalleeInterface extends ethers.utils.Interface {
    functions: {
...
export interface IFlashLendingCallee extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: IFlashLendingCalleeInterface;
