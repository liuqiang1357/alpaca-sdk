...
export interface PCSFlashLiquidatorInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "alpacaStablecoin",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export type LogFlashLiquidationEvent = TypedEvent<
...
export type LogFlashLiquidationEventFilter =
  TypedEventFilter<LogFlashLiquidationEvent>;

export type LogSellCollateralEvent = TypedEvent<
  [BigNumber, BigNumber, BigNumber],
  { amount: BigNumber; minAmountOut: BigNumber; actualAmountOut: BigNumber }
>;

export type LogSellCollateralEventFilter =
  TypedEventFilter<LogSellCollateralEvent>;
...
export interface PCSFlashLiquidator extends BaseContract {
  ...
  functions: {
    ...
    flashLendingCall(
      _caller: string,
      _debtValueToRepay: BigNumberish,
      _collateralAmountToLiquidate: BigNumberish,
      data: BytesLike,
    ...
    initialize(
      _bookKeeper: string,
      _alpacaStablecoin: string,
      _stablecoinAdapter: string,
      _wrappedNativeAddr: string,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
    ...
    whitelist(
      _toBeWhitelistedAddress: string,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    "LogFlashLiquidation(address,uint256,uint256,uint256)"(
      liquidatorAddress?: string | null,
      debtValueToRepay?: null,
      collateralAmountToLiquidate?: null,
      liquidationProfit?: null
    ): LogFlashLiquidationEventFilter;
    LogFlashLiquidation(
      liquidatorAddress?: string | null,
      debtValueToRepay?: null,
      collateralAmountToLiquidate?: null,
    ...
    "LogSellCollateral(uint256,uint256,uint256)"(
      amount?: null,
      minAmountOut?: null,
      actualAmountOut?: null
    ): LogSellCollateralEventFilter;
    LogSellCollateral(
      amount?: null,
      minAmountOut?: null,
      actualAmountOut?: null
