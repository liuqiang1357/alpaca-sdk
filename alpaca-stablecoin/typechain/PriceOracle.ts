...
export interface PriceOracleInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "setStableCoinReferencePrice",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "stableCoinReferencePrice",
    values?: undefined
  ): string;
  ...
  getEvent(
    nameOrSignatureOrTopic: "LogSetStableCoinReferencePrice"
  ): EventFragment;
...
export type LogSetPriceEvent = TypedEvent<
  [string, string, BigNumber],
  { _poolId: string; _rawPrice: string; _priceWithSafetyMargin: BigNumber }
>;

export type LogSetPriceEventFilter = TypedEventFilter<LogSetPriceEvent>;

export type LogSetStableCoinReferencePriceEvent = TypedEvent<
  [string, BigNumber],
  { _caller: string; _data: BigNumber }
>;

export type LogSetStableCoinReferencePriceEventFilter =
  TypedEventFilter<LogSetStableCoinReferencePriceEvent>;
...
export interface PriceOracle extends BaseContract {
  ...
  filters: {
    ...
    "LogSetPrice(bytes32,bytes32,uint256)"(
      _poolId?: null,
      _rawPrice?: null,
      _priceWithSafetyMargin?: null
    ): LogSetPriceEventFilter;
    LogSetPrice(
      _poolId?: null,
      _rawPrice?: null,
      _priceWithSafetyMargin?: null
    ...
    "LogSetStableCoinReferencePrice(address,uint256)"(
      _caller?: string | null,
      _data?: null
    ): LogSetStableCoinReferencePriceEventFilter;
    LogSetStableCoinReferencePrice(
      _caller?: string | null,
      _data?: null
    ): LogSetStableCoinReferencePriceEventFilter;
