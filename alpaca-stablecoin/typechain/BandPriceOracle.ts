...
export interface BandPriceOracleInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "stdReferenceProxy",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export type LogSetTokenSymbolEvent = TypedEvent<
  [string, string],
  { _tokenAddress: string; _tokenSymbol: string }
>;

export type LogSetTokenSymbolEventFilter =
  TypedEventFilter<LogSetTokenSymbolEvent>;
...
export interface BandPriceOracle extends BaseContract {
  ...
  filters: {
    "LogSetTokenSymbol(address,string)"(
      _tokenAddress?: string | null,
      _tokenSymbol?: null
    ): LogSetTokenSymbolEventFilter;
    LogSetTokenSymbol(
      _tokenAddress?: string | null,
      _tokenSymbol?: null
    ): LogSetTokenSymbolEventFilter;
